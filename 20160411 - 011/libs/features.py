    ...
    for i in range(len(fl)):
        if (fl[i][1]):
            ...
            if (fl[i][0] == 'length'):
                ...
                tc_0, td_0 = findMaxString(text, 0)
                ft += [len(td_0)]
            elif (fl[i][0] == '#max_digit_skip_0 >= 7'):
                tc_0, td_0 = findMaxString(text, 0)
                ft += [1 if len(td_0) > max_digit_min_limit else 0]
            elif (fl[i][0] == '#max_digit_skip_0 = 0'):
                tc_0, td_0 = findMaxString(text, 0)
            ...
            elif (fl[i][0] == '#max_ascii_skip_0 >= 7'):
                tc_0, td_0 = findMaxString(text, 0)
                ft += [1 if len(tc_0) > max_ascii_min_limit else 0]
            elif (fl[i][0] == '#max_ascii_skip_0 = 0'):
                tc_0, td_0 = findMaxString(text, 0)
                ft += [1 if len(tc_0) == 0 else 0]
